...
public class ExerciciosStreamAPI {
    public static void main(String[] args) {
        ...
        System.out.println("------ Utilizando Lambda e removendo o stream  ---------------");
        numerosAleatorios.forEach(s -> System.out.println(s));

        System.out.println("------ Utilizando Lambda, removendo o stream e utilizando method reference  ---------------");
        ...
        numerosAleatorios.stream()
                ...
                .forEach(System.out::println); //Não aceita números repetidos

        System.out.println("Passando o set para uma variável");
        ...
        numerosAleatorios.stream()
                ...
                .forEach(System.out::println); // caso não passe para uma variável



        System.out.println("\nPegue os números pares e maiores que 2 e coloque em uma lista:");
        List<Integer> numerosInteirosMaioresDois = numerosAleatoriosInteiros.stream()
                //.map(Integer::parseInt). //Já está transformado em inteiro
        ...
        System.out.println(numerosInteirosMaioresDois);
        ...
        System.out.println("------------------ Jogando para uma variável: -------------------");
